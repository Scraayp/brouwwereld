<template>
  <div class="flex justify-center items-center mt-36 mb-40">
    <div class="text-center max-w-6xl mx-10">
      <p class="my-3 text-sm tracking-widest text-indigo-500 uppercase">
        Fast &amp; SEO friendly
      </p>
      <h1
        class="my-3 text-3xl font-bold tracking-tight text-gray-800 md:text-5xl dark:text-gray-100"
      >
        Best Service Offered Here
      </h1>
      <div>
        <p
          class="max-w-2xl mx-auto my-2 text-base text-gray-500 md:leading-relaxed md:text-xl dark:text-gray-400"
        >
      ...
      >
        ...
        <a
          class="inline-block w-auto text-center min-w-[200px] px-6 py-4 text-white transition-all dark:bg-white dark:text-gray-800 rounded-md shadow-xl sm:w-auto hover:bg-gray-900 hover:text-white shadow-neutral-300 dark:shadow-neutral-700 hover:shadow-2xl hover:shadow-neutral-400 hover:-tranneutral-y-px"
          href=""
          >Seach Examples
        </a>
      </div>
